...
public class WebSecurityConfiguration {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers("/dusers/**").hasAnyRole(ADMIN.name(),TEAMLEADER.name())
		.antMatchers(GET,"/dusers/**").hasAnyAuthority(ADMIN_READ.name(),TEAMLEADER_READ.name())
		.antMatchers(PUT,"/dusers/**").hasAnyAuthority(ADMIN_UPDATE.name(),TEAMLEADER_UPDATE.name())
		.antMatchers(POST,"/dusers/**").hasAuthority(ADMIN_READ.name())
     	.antMatchers(DELETE,"/dusers/**").hasAuthority(ADMIN_DELETE.name())
